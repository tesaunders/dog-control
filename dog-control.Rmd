...
---
A number of concerning dog attacks have been reported in the media recently:

* Neville Thomson was [mauled to death](https://www.rnz.co.nz/news/national/472476/fatal-northland-dog-attack-victim-s-family-want-answers-from-boarder) by a pack of dogs belonging to a friend who was boarding on his property in Pānguru, Northland.
* An elderly woman in the Northland community of Moerewa was [killed](https://www.rnz.co.nz/news/national/500060/community-shocked-after-fatal-dog-attack-in-moerewa), and two others were injured, after a roaming dog came onto her property and attacked her as she was hanging out washing.
* ["Unleashed"](https://www.tvnz.co.nz/shows/sunday/clips/unleashed) featured an investigation by current affairs programme "Sunday" into a vicious attack on a 5 year old in Rotorua and the wider issue of increasing dog attacks in New Zealand.
...
The following analyses have been performed on a dataset compiled from these annual reports starting in 2014. The complete dataset, and R code used to perform all the analyses, is available [here](https://github.com/tesaunders/dog-control).
...
The number of known dogs has increased dramatically since 2020. Note: the drop in 2018 reflects work to remove duplicate entries from the register in 2017.
...
ggplot(attacks, aes(x = financial_year)) +
  geom_smooth(aes(y = `type_aggressive-people`, colour = "Aggressive to People"), se = FALSE, linewidth = 0.8) +
  geom_smooth(aes(y = `type_attack-animals`, colour = "Attack on Animal"), se = FALSE, linewidth = 0.8) +
  geom_smooth(aes(y = `type_aggressive-animals`, colour = "Aggressive to Animal"), se = FALSE, linewidth = 0.8) +
